...
func TestRouterAdd(t *testing.T) {
    ...
    var tests = []struct{json, content string; status int}{
...
// Проверить успешный результат по id.
func TestRouterGetId(t *testing.T) {
    var tests = []struct{id string; status int}{
        ...
        { "0", http.StatusNoContent}, // несуществующий id
...
func 
makeRequest(method, url, ct string, body io.Reader) (*http.Response, error) {
